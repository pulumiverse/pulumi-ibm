...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"ibm_cis_firewall_rule":                                  {Tok: tfbridge.MakeResource(mainPkg, "internetServices", "CisFirewallRule")},
			...
			"ibm_cis_logpush_job":                                    {Tok: tfbridge.MakeResource(mainPkg, "internetServices", "CisLogpushJob")},
			...
			"ibm_pi_ike_policy":                                      {Tok: tfbridge.MakeResource(mainPkg, "powerSystems", "PiIkePolicy")},
			...
			"ibm_pi_ipsec_policy":                                    {Tok: tfbridge.MakeResource(mainPkg, "powerSystems", "PiIpsecPolicy")},
			...
			"ibm_scc_rule":                                           {Tok: tfbridge.MakeResource(mainPkg, "securityComplianceCenter", "SccRule")},
			"ibm_scc_rule_attachment":                                {Tok: tfbridge.MakeResource(mainPkg, "securityComplianceCenter", "SccRuleAttachment")},
			...
			"ibm_scc_template":                                       {Tok: tfbridge.MakeResource(mainPkg, "securityComplianceCenter", "SccTemplate")},
			"ibm_scc_template_attachment":                            {Tok: tfbridge.MakeResource(mainPkg, "securityComplianceCenter", "SccTemplateAttachment")},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"ibm_container_vpc_cluster_worker_pool_zone":              {Tok: tfbridge.MakeDataSource(mainPkg, "kubernetesService", "getContainerVpcClusterWorkerPoolZone")},
