...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"ibm_app_domain_private":                                 {Tok: tfbridge.MakeResource(mainPkg, "appConfiguration", "AppDomainPrivate")},
			"ibm_app_domain_shared":                                  {Tok: tfbridge.MakeResource(mainPkg, "appConfiguration", "AppDomainShared")},
			"ibm_app_route":                                          {Tok: tfbridge.MakeResource(mainPkg, "appIdManagement", "AppRoute")},
